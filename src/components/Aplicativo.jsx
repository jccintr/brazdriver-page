...
const Aplicativo = () => {
  return (
    <div className='bg-gray-200 py-8 flex flex-col-reverse w-full items-center justify-center gap-2 md:flex-row  md:justify-around md:px-72 md:items-start'>
         ...
         <div className='flex flex-col gap-4 items-center'>
            ...
            <img src={googleplay} alt='logo' className='w-40 md:w-72' />
         </div>
    </div>
  )
}
